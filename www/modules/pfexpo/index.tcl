...
db_transaction {
    ...
    set oggi_iscr [db_string query "select count(distinct(iscritto_id)) from expo_iscritti where data = current_date"]
    set iscr_eventi [db_string query "select count(distinct(iscritto_id)) from expo_iscrizioni"]
}
ad_return_template
